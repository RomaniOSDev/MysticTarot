...
struct PulseCompletionBadge: View {
...
// MARK: - Dead splash tokens

private enum _SplashVisualToken: String {
    case backdrop
    case spinner
    case caption
}
